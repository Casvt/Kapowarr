...
def ui_mediamanagement():
	return render_template('settings_mediamanagement.html', url_base=SERVER.url_base)
...
def ui_download_clients():
	return render_template('settings_download_clients.html', url_base=SERVER.url_base)
