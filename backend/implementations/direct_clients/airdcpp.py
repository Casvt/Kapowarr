...
class AirDCPPSearch:
    ...
    def perform_search(self, query: str, wait_time: int = 15) -> List[Dict[str, Any]]:
        """Perform a search on AirDC++ hubs and filter for comic formats.
        ...
        Returns:
            List[Dict[str, Any]]: Filtered search results (comic formats only)
        """
        ...
        try:
            ...
            for result in result_list:
                ...
                if any(file_name.endswith(ext) for ext in FileConstants.CONTAINER_EXTENSIONS):
